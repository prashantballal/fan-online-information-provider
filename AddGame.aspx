<%@ Page Title="FAN - Add Game" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="AddGame.aspx.cs" Inherits="AddGame" %>
...
<asp:Image ID="Image2" runat="server" ImageUrl="~/Images/INDICIUM[db].png"></asp:Image>
    ...
    <br />
    <br />
    <asp:Label ID="lblMsg" runat="server" Text="ADD GAME" Font-Names="Calibri" Font-Size="XX-Large" ForeColor="#006699" Font-Bold="True" Font-Underline="True"></asp:Label>
    <br />
    <br />
    <br />
