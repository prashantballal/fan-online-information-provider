...
public partial class AddTV : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["11project"].ToString());
            con.Open();
            string insert = "insert into tvs(series_name, image, writer_name, director_name, producer_name, release_date, description, starring) values('" + tv_name + "', '" + path + "', '" + wr_name + "', '" + dr_name + "' , '" + pr_name + "', '" + Convert.ToDateTime(date) + "', '" + desc + "', '" + str + "')";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd2 = new SqlCommand("update tvs set image='" + path + "' where series_name='" + txtTVName.Text + "'", con);
            ...
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["11project"].ToString());
            con.Open();
            string query = "select image from tvs where series_name='" + txtTVName.Text + "'";
